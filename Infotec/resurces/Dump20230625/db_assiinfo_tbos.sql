...
--
-- Host: localhost    Database: db_assiinfo
-- ------------------------------------------------------
...
CREATE TABLE `tbos` (
  ...
  `valor_conserto` decimal(10,2) DEFAULT NULL,
  `idCli` int NOT NULL,
  PRIMARY KEY (`idOS`),
  KEY `idCli` (`idCli`),
  CONSTRAINT `tbos_ibfk_1` FOREIGN KEY (`idCli`) REFERENCES `tbclientes` (`id`)
...
-- Dump completed on 2023-06-25 19:36:58
